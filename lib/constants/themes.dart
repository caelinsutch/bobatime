...
class AppThemes {
  ...
  static String mainFont = "PollyRounded";
  static String secondaryFont = "OpenSans";
  //constants color range for light theme
  //main color
  static const Color _lightPrimaryColor = bobaGreen;
...
//  static const Color _lightAlertTextColor = Colors.white;
//  static const Color _lightTextSecondaryColor = Colors.white;
...
//  static const Color _lightInputFillColor = _lightBackgroundSecondaryColor;
  ...
  static const Color _darkPrimaryColor = bobaGreen;
...
//  static const Color _darkAlertTextColor = Colors.white;
//  static const Color _darkTextSecondaryColor = Colors.white;
  ...
  static final TextTheme _lightTextTheme = TextTheme(
    headline1: TextStyle(
        fontSize: 36.0, color: _lightTextColor, fontWeight: FontWeight.bold),
    bodyText1: TextStyle(
        fontSize: 14.0, fontFamily: secondaryFont, fontWeight: FontWeight.bold),
    bodyText2: TextStyle(
        fontSize: 14.0,
        fontFamily: mainFont,
        color: Colors.grey,
    ...
    headline6: TextStyle(
        fontSize: 14.0, color: _lightTextColor, fontWeight: FontWeight.bold),
  ...
  static final TextTheme _darkTextTheme = TextTheme(
    headline1: TextStyle(
        fontSize: 36.0, color: _darkTextColor, fontWeight: FontWeight.bold),
    bodyText1: TextStyle(
    ...
    headline6: TextStyle(
        fontSize: 16.0, color: _darkTextColor, fontWeight: FontWeight.bold),
